...
from ex127.MainWindow127 import Ui_MainWindow
import pandas as pd


class MainWindow127Ex(Ui_MainWindow):
    def __init__(self):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButtonSortPrice.clicked.connect(self.sort_by_price)
        self.pushButtonReduce.clicked.connect(self.search_symbol_and_reduce)
        self.pushButtonUSD.clicked.connect(self.add_usd_column)
        self.pushButtonAdd.clicked.connect(self.add_new_row)
        self.pushButtonStatistic.clicked.connect(self.group_and_statistics)
